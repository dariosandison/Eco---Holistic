...
const TAG = process.env.NEXT_PUBLIC_AMAZON_TAG || "YOURTAG-21";
// Helper to append your Amazon tag if missing
const withTag = (url) => (url.includes("tag=") ? url : `${url}${url.includes("?") ? "&" : "?"}tag=${TAG}`);
...
export default function Recommended() {
  ...
  const items = [
    {
      ...
      href: withTag("https://www.amazon.com/dp/B07S44J4Y3"),
      badge: "Editor’s Pick",
      price: "From $14–$22",
      rating: 5,
    },
    {
      ...
      href: withTag("https://www.amazon.com/dp/B07L5GDTYY"),
      badge: "Aromatherapy",
      price: "$25–$40",
      rating: 4,
    },
    {
      ...
      description: "Ditch plastic—keeps drinks cold for 24h, hot for 12h.",
      image: "https://m.media-amazon.com/images/I/61Yp-6b6S2L._AC_SL1500_.jpg",
      href: withTag("https://www.amazon.com/dp/B07KQX3H8R"),
      badge: "Sustainable",
      price: "$18–$30",
      rating: 5,
    },
    {
      ...
      href: withTag("https://www.amazon.com/dp/B07V26G3K9"),
      badge: "Low-Waste",
      price: "$8–$12",
      rating: 4,
    },
    {
      ...
      href: withTag("https://www.amazon.com/dp/B00GM5P05O"),
      badge: "Kitchen",
      price: "$20–$35",
      rating: 4,
    },
    {
      ...
      href: withTag("https://www.amazon.com/dp/B0797HZ8P5"),
      badge: "Wellness",
      price: "$16–$25",
      rating: 4,
    },
  ...
  return (
    <>
      <Head>
        <title>Recommended • Eco & Holistic Picks | {site}</title>
        <meta
          name="description"
      ...
      <main className="container">
        ...
        <p className="fine">
          *Information is educational only and not a substitute for professional
          medical advice.
        </p>
      </main>
