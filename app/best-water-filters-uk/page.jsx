...
export const metadata = {
  ...
  description: 'Choose the right water-filter format for a UK home, compare running costs and testing claims, then use our current partner shortlist to compare products.',
}
    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <header>
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-4 flex flex-wrap gap-2"><Link className="btn-primary" href="/water-filtration-shortlist-uk">Compare current partner options</Link><Link className="btn-secondary" href="/blog/filter-replacement-costs-uk">Replacement costs</Link><Link className="btn-secondary" href="/best-shower-filters-uk-hard-water">Shower filtration</Link></div>
      ...
      <section className="mt-14 rounded-3xl border border-zinc-200 bg-zinc-50/60 p-6"><div className="max-w-3xl"><p className="text-sm font-semibold uppercase tracking-[0.14em] text-zinc-500">Current buying layer</p><h2 className="mt-2 text-2xl font-semibold">One shortlist, rather than several competing product lists</h2><p className="mt-2 text-zinc-700">Wild & Well keeps the current partner products in the main filtration shortlist. This page focuses on the buying decision while the shortlist groups portable filters, jugs, under-sink systems, gravity filtration and replacement products in one maintained location.</p><div className="mt-5 flex flex-wrap gap-2"><Link className="btn-primary" href="/water-filtration-shortlist-uk">Open water filtration shortlist</Link><Link className="btn-secondary" href="/topics/water">Learn about filtration first</Link></div></div></section>
