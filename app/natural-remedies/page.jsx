export const metadata = {
  ...
  description: "Evidence-informed natural remedies and supplement guides, designed for beginners.",
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="text-zinc-700 mb-6">Evidence-informed natural remedies and supplement guides, designed for beginners.</p>
