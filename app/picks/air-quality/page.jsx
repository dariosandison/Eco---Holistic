    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      <header className="max-w-3xl">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Link className="btn-secondary" href="/guides/healthy-air-at-home">Read the air guide</Link>
      ...
      <section className="mt-12 grid gap-4 md:grid-cols-3">
        ...
        <div className="card">
          ...
          <div className="mt-4 flex gap-2 flex-wrap">
            <Link className="btn-secondary" href="/guides/winter-humidity-guide">Winter humidity guide</Link>
          </div>
        </div>
        <div className="card">
