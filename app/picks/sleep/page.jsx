    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      <header className="max-w-3xl">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Link className="btn-secondary" href="/guides/sleep-naturally-without-overwhelm">Start with the cornerstone guide</Link>
      ...
      <section className="mt-14">
        ...
        <div className="mt-8 flex flex-wrap gap-2">
          ...
          <Link className="btn-secondary" href="/guides/magnesium-for-sleep-basics">Read: magnesium basics</Link>
        </div>
      </section>
