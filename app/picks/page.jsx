  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <section className="mt-10 grid gap-4 md:grid-cols-2">
        <Card title="Sleep & recovery" desc="The simplest path to better sleep: light, timing, temperature, and the few products that actually help." href="/picks/sleep" tag="Sleep" />
        <Card title="Air quality (allergies + damp)" desc="What matters in HEPA, where to place it, and our short list for small flats and allergy seasons." href="/picks/air-quality" tag="Home" />
        <Card title="Water (filters + hydration)" desc="Under-sink vs jugs, what certifications mean, and the starter picks that work in UK homes." href="/picks/water" tag="Kitchen" />
        <Card title="Fragrance-free cleaning & laundry" desc="Sensitive-skin friendly cleaning, laundry, and the quick swaps that reduce irritation fast." href="/picks/fragrance-free" tag="Cleaning" />
      </section>
