...
export default function Page() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <section className="mt-14 rounded-3xl border border-zinc-200 bg-zinc-50/60 p-6"><div className="max-w-3xl"><p className="text-sm font-semibold uppercase tracking-[0.14em] text-zinc-500">Compare useful options</p><h2 className="mt-2 text-2xl font-semibold">Choose recovery tools by the problem they solve</h2><p className="mt-2 text-zinc-700">The maintained Movement shortlist keeps product comparison focused on practical use, fit and the habits the equipment is meant to support.</p><div className="mt-5"><Link className="btn-primary" href="/movement/movement-shortlist">Open Movement shortlist</Link></div></div></section>
