...
export default function Page() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <section className="mt-14 rounded-3xl border border-zinc-200 bg-zinc-50/60 p-6"><div className="max-w-3xl"><p className="text-sm font-semibold uppercase tracking-[0.14em] text-zinc-500">Current buying route</p><h2 className="mt-2 text-2xl font-semibold">Keep equipment comparisons in the Movement shortlist</h2><p className="mt-2 text-zinc-700">The old page repeated six generic marketplace searches twice. This guide now explains the equipment decision, while the maintained Movement shortlist carries current partner options for home strength.</p><div className="mt-5"><Link className="btn-primary" href="/movement/movement-shortlist#home-strength-basics">Open home-strength options</Link></div></div></section>
