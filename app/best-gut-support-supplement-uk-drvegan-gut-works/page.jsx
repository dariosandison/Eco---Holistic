...
export const metadata = {
  title: 'DR.VEGAN Gut Works (UK) — gut supplement guide',
...
export default function Page() {
  ...
  "@type": "Article",
  "headline": "Gut support (UK): DR.VEGAN Gut Works",
    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <header>
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold">Gut support (UK): DR.VEGAN Gut Works</h1>
          <p className="mt-3 text-zinc-700">
            A conservative guide to gut blends: when they can help, who should be cautious, and how to trial them properly.
          </p>
        </div>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <ProductPick
            title="Gut support (UK): DR.VEGAN Gut Works"
            badge="Gut"
            description="A straightforward option to trial. Compare ingredients/specs and use the return policy if it’s not a fit."
            bullets={["Best for: a time-boxed trial when basics are already stable", "Track symptoms for 2–4 weeks; avoid stacking other changes", "If you worsen, stop and reassess"]}
            links={[
              { label: 'Check price', merchant: 'awin', href: FEATURED_AWIN, variant: 'primary' },
              { label: 'Compare alternatives', merchant: 'amazon', href: amazonSearchUrl('gut health supplement blend UK'), variant: 'ghost' },
            ]}
          />
        </div>
      </section>
