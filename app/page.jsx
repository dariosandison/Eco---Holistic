    ...
    <main>
      ...
      <section className="relative isolate">
        ...
        <div className="absolute inset-0 -z-10">
          <Image
            src="/og.png"  // change if your OG file has a different name in /public
            alt=""
            fill
            priority
            sizes="100vw"
          ...
          />
          {/* Gentle overlay so foreground stays legible */}
          <div className="absolute inset-0 bg-gradient-to-b from-white/70 via-white/30 to-white" />
        </div>

        {/* Content anchored at bottom so it clears the background logo */}
        <div className="mx-auto flex h-[68vh] max-w-6xl items-end px-4 pb-10 md:h-[74vh]">
          <div className="w-full max-w-2xl">
            ...
            <p className="mt-6 text-base text-zinc-700 md:text-lg">
              Make switching to low-tox, eco-friendly products easy — clear picks, simple checkli
