...
export default function Page() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <section className="mt-14 rounded-3xl border border-zinc-200 bg-zinc-50/60 p-6"><div className="max-w-3xl"><p className="text-sm font-semibold uppercase tracking-[0.14em] text-zinc-500">Compare walking footwear</p><h2 className="mt-2 text-2xl font-semibold">Choose for fit, comfort and gradual use</h2><p className="mt-2 text-zinc-700">The maintained Movement shortlist includes current footwear options and a separate barefoot/foot-strength route where that approach is relevant.</p><div className="mt-5"><Link className="btn-primary" href="/movement/movement-shortlist#barefoot-footwear">Open footwear options</Link></div></div></section>
