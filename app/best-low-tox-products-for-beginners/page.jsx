...
const JUNGLECULTURE_LOOFAH = 'https://www.awin1.com/cread.php?awinmid=26152&awinaffid=2754234&clickref=ww_home_lowtox_jungleculture_natural_loofah&ued=https%3A%2F%2Fjungleculture.eco%2Fcollections%2Fbest-selling-products%2Fproducts%2Fnatural-loofah-sponge'
...
<section className="mt-10">
      ...
      <section className="mt-12">
        <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-600 max-w-2xl">
              Four low‑friction swaps we feature for beginners. (Links are affiliate links.)
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          />
          <ProductPick
            title="Bathroom swap: Natural loofah sponge"
            badge="Plastic‑free"
            description="A low‑friction swap for reducing plastic sponges. Replace regularly and let it dry properly between uses."
            bullets={["Great for: daily shower swaps", "Let it dry fully", "Replace when worn"]}
            links={[{ label: 'Check price', merchant: 'awin', href: JUNGLECULTURE_LOOFAH, variant: 'primary' }]}
          />
          <ProductPick
