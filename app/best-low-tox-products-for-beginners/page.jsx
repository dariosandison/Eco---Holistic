...
export const metadata = {
  title: "Best Low‑Tox Products for Beginners | Wild & Well",
...
export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      <h1 className="text-4xl font-bold mb-4">Best Low‑Tox Products for Beginners</h1>
      ...
      <p className="mt-10">
        For deeper context, read the related guide: <Link className="underline" href="/guides/non-toxic-cleaning-starter">start here →</Link>
      </p>
