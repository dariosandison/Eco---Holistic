...
export const metadata = {
  title: 'True Creatine (UK) — creatine supplement guide',
  description: 'A simple guide to creatine: what it does, how to take it, and how to buy without hype.',
}

const FEATURED_AWIN = 'https://www.awin1.com/cread.php?awinmid=54585&awinaffid=2754234&clickref=ww_movement_strength_ancient_true_creatine&ued=https%3A%2F%2Fancientandbrave.earth%2Fproducts%2Ftrue-creatine'

export default function Page() {
  const slug = 'best-creatine-supplement-uk-ancient-and-brave-true-creatine'
  const edu = getMoneyPageEdu(slug)

  const ld = {
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Creatine (UK): Ancient + Brave True Creatine",
    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <header>
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold">Creatine (UK): Ancient + Brave True Creatine</h1>
          <p className="mt-3 text-zinc-700">
            A simple guide to creatine: what it does, how to take it, and how to buy without hype.
          </p>
        </div>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <ProductPick
            title="Creatine (UK): Ancient + Brave True Creatine"
            badge="Strength"
            description="A straightforward option to trial. Compare ingredients/specs and use the return policy if it’s not a fit."
            bullets={["Best for: strength training + high‑output sessions", "Typical approach: daily dosing; consistency beats timing", "Drink water; avoid adding lots of new supplements at once"]}
            links={[
              { label: 'Check price', merchant: 'awin', href: FEATURED_AWIN, variant: 'primary' },
              { label: 'Compare alternatives', merchant: 'amazon', href: amazonSearchUrl('creatine monohydrate powder UK unflavoured'), variant: 'ghost' },
            ]}
          />
        </div>
      </section>
