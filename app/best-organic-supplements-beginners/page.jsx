...
export default function Page() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <section className="mt-14 rounded-3xl border border-zinc-200 bg-zinc-50/60 p-6"><div className="max-w-3xl"><p className="text-sm font-semibold uppercase tracking-[0.14em] text-zinc-500">Current nutrition route</p><h2 className="mt-2 text-2xl font-semibold">Food first; targeted supplements second</h2><p className="mt-2 text-zinc-700">The previous version was another six-item generic marketplace shortlist. We have removed that duplicate catalogue. The main buying path now starts with food-first nutrition, with targeted supplement pages kept for specific questions where they add value.</p><div className="mt-5 flex flex-wrap gap-2"><Link className="btn-primary" href="/nutrition/food-first-shortlist">Open food-first shortlist</Link><Link className="btn-secondary" href="/nutrition/supplements">Read supplement guidance</Link></div></div></section>
