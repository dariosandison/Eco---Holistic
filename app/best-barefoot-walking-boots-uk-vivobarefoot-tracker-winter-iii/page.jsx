...
export const metadata = {
  title: 'Vivobarefoot Tracker Winter III (UK) — barefoot boots guide',
  description: 'A practical guide to barefoot boots: who they suit, how to transition safely, and what to compare before buying.',
}

const FEATURED_AWIN = 'https://www.awin1.com/cread.php?awinmid=7778&awinaffid=2754234&clickref=ww_movement_footstrength_vivo_tracker_winter_iii&ued=https%3A%2F%2Fwww.vivobarefoot.com%2Fuk%2Ftracker-winter-iii-sg-mens%3Futm_source%3Dchatgpt.com'
...
export default function Page() {
  ...
  "@type": "Article",
  "headline": "Barefoot walking boots (UK): Vivobarefoot Tracker Winter III",
    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <header>
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold">Barefoot walking boots (UK): Vivobarefoot Tracker Winter III</h1>
          <p className="mt-3 text-zinc-700">
            A practical guide to barefoot boots: who they suit, how to transition safely, and what to compare before buying.
          </p>
        </div>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <ProductPick
            title="Barefoot walking boots (UK): Vivobarefoot Tracker Winter III"
            badge="Foot strength"
            description="A straightforward option to trial. Compare ingredients/specs and use the return policy if it’s not a fit."
            bullets={["Best for: outdoor walking when you want ground feel + foot strength", "Transition slowly (short walks first) to avoid calf/foot overload", "Fit matters: follow sizing guidance and return policy"]}
            links={[
              { label: 'Check price', merchant: 'awin', href: FEATURED_AWIN, variant: 'primary' },
              { label: 'Compare alternatives', merchant: 'amazon', href: amazonSearchUrl('barefoot hiking boots men women UK'), variant: 'ghost' },
            ]}
          />
        </div>
      </section>
