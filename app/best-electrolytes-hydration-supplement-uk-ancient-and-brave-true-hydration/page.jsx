...
export const metadata = {
  title: 'True Hydration (UK) — electrolytes guide',
  description: 'A practical guide to electrolytes: when they help, who needs them, and how to read the label.',
}

const FEATURED_AWIN = 'https://www.awin1.com/cread.php?awinmid=54585&awinaffid=2754234&clickref=ww_nutrition_hydration_ancient_true_hydration&ued=https%3A%2F%2Fancientandbrave.earth%2Fproducts%2Ftrue-hydration'

export default function Page() {
  const slug = 'best-electrolytes-hydration-supplement-uk-ancient-and-brave-true-hydration'
  const edu = getMoneyPageEdu(slug)

  const ld = {
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Electrolytes (UK): Ancient + Brave True Hydration",
    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <header>
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold">Electrolytes (UK): Ancient + Brave True Hydration</h1>
          <p className="mt-3 text-zinc-700">
            A practical guide to electrolytes: when they help, who needs them, and how to read the label.
          </p>
        </div>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <ProductPick
            title="Electrolytes (UK): Ancient + Brave True Hydration"
            badge="Hydration"
            description="A straightforward option to trial. Compare ingredients/specs and use the return policy if it’s not a fit."
            bullets={["Best for: sweaty training days, sauna, or long walks", "Check sodium per serving and sweeteners/flavourings", "Use as a convenience tool — food and water still come first"]}
            links={[
              { label: 'Check price', merchant: 'awin', href: FEATURED_AWIN, variant: 'primary' },
              { label: 'Compare alternatives', merchant: 'amazon', href: amazonSearchUrl('electrolyte powder no sugar UK'), variant: 'ghost' },
            ]}
          />
        </div>
      </section>
