...
export const metadata = {
  ...
  description: 'A practical UK guide to damp, condensation and laundry drying: measure humidity, address moisture sources, then choose the right dehumidifier route.',
}
    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <header>
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-4 flex flex-wrap gap-2"><Link className="btn-primary" href="/air-quality-shortlist-uk#dehumidifiers">Compare current dehumidifier options</Link><Link className="btn-secondary" href="/blog/winter-humidity-guide">Winter humidity guide</Link><Link className="btn-secondary" href="/topics/air-quality">Air quality hub</Link></div>
      ...
      <section className="mt-14 rounded-3xl border border-zinc-200 bg-zinc-50/60 p-6">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.14em] text-zinc-500">Ready to compare?</p>
          <h2 className="mt-2 text-2xl font-semibold">Use the central Air Quality shortlist</h2>
          <p className="mt-2 text-zinc-700">This page now handles the damp/dehumidifier decision. The main Air Quality shortlist is where Wild & Well keeps current partner dehumidifier options, so we do not maintain several competing product lists across different articles.</p>
          <div className="mt-5 flex flex-wrap gap-2"><Link className="btn-primary" href="/air-quality-shortlist-uk#dehumidifiers">Compare dehumidifiers</Link><Link className="btn-secondary" href="/best-dehumidifier-air-purifier-uk-meaco-arete-one-25l">Read the Meaco Arete guide</Link></div>
        </div>
      </section>
