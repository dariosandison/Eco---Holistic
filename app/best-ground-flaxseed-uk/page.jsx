...
export const metadata = {
  title: "Best Ground Flaxseed (UK) | Wild & Well",
  ...
  return (
    <div className="rounded-2xl border bg-white p-6 shadow-sm">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        <Link className="btn-secondary" href="/blog/fibre-gut-health-practical-guide">Wellness Insights: fibre & gut health</Link>
      </div>
...
export default function Page() {
  ...
  const ld = {
    ...
    '@type': 'Article',
    headline: "Best Ground Flaxseed (UK)",
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <header className="max-w-3xl">
        <h1 className="text-4xl font-bold">Best ground flaxseed (UK)</h1>
