...
export const metadata = {
  title: 'Algae Omega‑3 (UK) — omega‑3 supplement guide',
...
export default function Page() {
  ...
  "@type": "Article",
  "headline": "Omega‑3 supplement (UK): Together Health Algae Omega‑3",
    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <header>
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold">Omega‑3 supplement (UK): Together Health Algae Omega‑3</h1>
          <p className="mt-3 text-zinc-700">
            A beginner-friendly guide to algae omega‑3: what to look for, who it suits, and how to compare options.
          </p>
        </div>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <ProductPick
            title="Omega‑3 supplement (UK): Together Health Algae Omega‑3"
            badge="Omega‑3"
            description="A straightforward option to trial. Compare ingredients/specs and use the return policy if it’s not a fit."
            bullets={["Best for: a plant‑based omega‑3 route (DHA/EPA)", "Check the serving (mg DHA/EPA) and how many capsules per day", "Keep expectations realistic — consistency matters more than brand"]}
            links={[
              { label: 'Check price', merchant: 'awin', href: FEATURED_AWIN, variant: 'primary' },
              { label: 'Compare alternatives', merchant: 'amazon', href: amazonSearchUrl('algae omega 3 dha epa supplement UK'), variant: 'ghost' },
            ]}
          />
        </div>
      </section>
