...
export default function Page() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <section className="mt-14 rounded-3xl border border-zinc-200 bg-zinc-50/60 p-6"><div className="max-w-3xl"><p className="text-sm font-semibold uppercase tracking-[0.14em] text-zinc-500">Compare movement gear</p><h2 className="mt-2 text-2xl font-semibold">Choose a mat for the way you move</h2><p className="mt-2 text-zinc-700">Use grip, cushioning, durability and storage as the main criteria, then compare current partner options in the Movement shortlist.</p><div className="mt-5"><Link className="btn-primary" href="/movement/movement-shortlist#home-strength-basics">Open movement gear options</Link></div></div></section>
