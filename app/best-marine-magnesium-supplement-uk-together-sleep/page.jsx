...
export const metadata = {
  title: 'Marine Magnesium (UK) — magnesium for sleep guide',
...
export default function Page() {
  ...
  "@type": "Article",
  "headline": "Magnesium for sleep (UK): Together Marine Magnesium",
    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <header>
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold">Magnesium for sleep (UK): Together Marine Magnesium</h1>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <ProductPick
            title="Magnesium for sleep (UK): Together Marine Magnesium"
            badge="Wind‑down"
            description="A straightforward option to trial. Compare ingredients/specs and use the return policy if it’s not a fit."
            bullets={["Best for: gentle wind‑down support alongside a routine", "Start low; assess tolerance; avoid stacking multiple new supplements", "If you’re on medication, check interactions first"]}
            links={[
              { label: 'Check price', merchant: 'awin', href: FEATURED_AWIN, variant: 'primary' },
              { label: 'Compare alternatives', merchant: 'amazon', href: amazonSearchUrl('magnesium glycinate bisglycinate supplement UK'), variant: 'ghost' },
            ]}
          />
        </div>
      </section>
