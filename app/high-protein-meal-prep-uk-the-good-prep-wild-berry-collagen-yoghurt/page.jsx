...
export const metadata = {
  ...
  description: 'A practical guide to meal prep services and high‑protein options: how to choose, what to check on labels, and how to use it without over-relying on it.',
}

const FEATURED_AWIN = 'https://www.awin1.com/cread.php?awinmid=16134&awinaffid=2754234&clickref=ww_nutrition_mealprep_goodprep_wildberry_collagen&ued=https%3A%2F%2Fthegoodprep.com%2Fproduct%2Fwild-berry-collagen-protein-yoghurt-large%2F%3Futm_source%3Dchatgpt.com'
...
export default function Page() {
  ...
  "@type": "Article",
  "headline": "High‑protein meal prep (UK): The Good Prep Wild Berry Collagen Yoghurt",
    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      ...
      <header>
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold">High‑protein meal prep (UK): The Good Prep Wild Berry Collagen Yoghurt</h1>
          <p className="mt-3 text-zinc-700">
            A practical guide to meal prep services and high‑protein options: how to choose, what to check on labels, and how to use it without over-relying on it.
          </p>
        </div>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <ProductPick
            title="High‑protein meal prep (UK): The Good Prep Wild Berry Collagen Yoghurt"
            badge="Meal prep"
            description="A straightforward option to trial. Compare ingredients/specs and use the return policy if it’s not a fit."
            bullets={["Best for: busy weeks when you want protein without decision fatigue", "Check sugar/additives and serving size", "Use as a bridge — keep meals mostly food-first"]}
            links={[
              { label: 'Check price', merchant: 'awin', href: FEATURED_AWIN, variant: 'primary' },
              { label: 'Compare alternatives', merchant: 'amazon', href: amazonSearchUrl('high protein yoghurt collagen UK'), variant: 'ghost' },
            ]}
          />
        </div>
      </section>
