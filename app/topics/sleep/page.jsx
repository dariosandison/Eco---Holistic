    ...
    <main className="mx-auto max-w-6xl px-4 py-16">
      <header className="max-w-3xl">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <Link className="btn-secondary" href="/blog/morning-light-sleep-10-minute-plan">Morning light 10‑min plan</Link>
      ...
      <section className="mt-14" id="options">
        ...
        <p className="section-subtitle">If you’ve done the basics for 1–2 weeks and want extra support, these broad links help you compare simple, low-friction options.</p>
