...
export function makeThumbDataUri({ title = '', tag = '', slug = '' } = {}) {
  ...
  const hue = 160 + (seed % 40) // teal-ish range
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="800" viewBox="0 0 1200 800">
    <defs>
      <linearGradient id="g" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0" stop-color="hsl(${hue}, 35%, 92%)"/>
        <stop offset="1" stop-color="hsl(${hue}, 45%, 84%)"/>
      </linearGradient>
    </defs>
    <rect width="1200" height="800" fill="url(#g)"/>
    <circle cx="980" cy="180" r="220" fill="hsl(${hue}, 45%, 78%)" opacity="0.55"/>
    <circle cx="260" cy="680" r="260" fill="hsl(${hue}, 45%, 74%)" opacity="0.35"/>

    <rect x="70" y="90" width="1060" height="620" rx="44" fill="rgba(255,255,255,0.70)" stroke="rgba(0,0,0,0.06)"/>

    <text x="120" y="190" font-family="ui-sans-serif, system-ui, -apple-system" font-size="34" fill="rgba(15, 23, 42, 0.65)">
      Wild &amp; Well • ${tagSafe}
    </text>
