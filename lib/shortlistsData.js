...
export const SHORTLIST_SECTIONS = [
  {
    ...
    items: [
      ...
      {
        label: 'Air quality partner shortlist (UK)',
        href: '/air-quality-shortlist-uk',
        tag: 'Air',
        desc: 'Direct partner links for air purifiers, dehumidifiers, filters and airflow options.',
        bestFor: 'Air comfort + humidity control',
        tradeOff: 'Filter and energy costs',
        updated: '2026-02-13',
      },
      {
      ...
      {
        label: 'Water filtration partner shortlist (UK)',
        href: '/water-filtration-shortlist-uk',
        tag: 'Water',
        desc: 'Direct partner links for bottles, jugs, under‑sink systems and shower options.',
        bestFor: 'Comparing partner products',
        tradeOff: 'Always check running costs',
        updated: '2026-02-13',
      },
      {
      ...
      {
        label: 'Dog wellness & pet-allergy shortlist (UK)',
        href: '/dog-wellness-shortlist-uk',
        tag: 'Dogs',
        desc: 'Evidence-led dog-home options, starting with approved pet-dander air filtration.',
        bestFor: 'Healthier homes with dogs',
        tradeOff: 'New dog partners under assessment',
        updated: '2026-09-01',
      },
{
        ...
        tag: 'Humidity',
        desc: 'A featured UK option for damp + laundry drying, with a simple sizing checklist.',
      ...
      },
{
      ...
      {
        label: 'Sleep & recovery partner shortlist (UK)',
        href: '/sleep-recovery-shortlist-uk',
        tag: 'Sleep',
        desc: 'Partner links for mattresses, pillows, bedding and conservative wind‑down options.',
        bestFor: 'One-upgrade-at-a-time',
        tradeOff: 'Avoid stacking changes',
        updated: '2026-02-13',
      },
      ...
      },
{
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: 'Movement partner shortlist (UK)',
        href: '/movement/movement-shortlist',
        tag: 'Movement',
        desc: 'Partner links for barefoot footwear, home strength basics and tracking.',
        bestFor: 'Low‑friction gear',
        tradeOff: 'Progress slowly',
        updated: '2026-02-13',
      },
      {
